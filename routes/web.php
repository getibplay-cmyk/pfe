...
Route::middleware(['auth', 'tenant', 'password.changed', 'verified'])->group(function () {
    ...
    Route::get('/dashboard/actions/{group}', DashboardActionController::class)->name('dashboard.actions');
    Route::get('/onboarding/import/{import}/errors', [OnboardingImportController::class, 'errors'])->whereUuid('import')->middleware('throttle:10,1,import-errors')->name('onboarding.import.errors');
