...
<body class="font-sans antialiased">
    ...
    <main id="contenu" class="grid min-h-screen lg:grid-cols-[minmax(0,1fr)_minmax(28rem,0.82fr)]">
        <section class="relative hidden overflow-hidden bg-atlas-ink p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-16" aria-label="Présentation de RentFleet">
            <x-brand-logo surface="dark" />
            <div class="max-w-xl">
                <p class="border-s-4 border-atlas-orange ps-3 text-xs font-bold uppercase tracking-[0.18em] text-brand-300">SaaS B2B multi-entreprises</p>
                ...
                <ul class="mt-8 grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
                    <li class="flex gap-2"><span aria-hidden="true" class="text-atlas-orange-soft">✓</span> Périmètre entreprise et agence</li>
                    <li class="flex gap-2"><span aria-hidden="true" class="text-atlas-orange-soft">✓</span> Autorisations par rôle</li>
                    <li class="flex gap-2"><span aria-hidden="true" class="text-atlas-orange-soft">✓</span> Historique et audit</li>
                    <li class="flex gap-2"><span aria-hidden="true" class="text-atlas-orange-soft">✓</span> Données privées protégées</li>
                </ul>
            </div>
            <p class="text-xs text-slate-400">Accès réservé aux organisations clientes et à leurs collaborateurs autorisés.</p>
        </section>
        <section class="flex items-center justify-center bg-atlas-canvas px-4 py-10 sm:px-8 lg:px-12">
