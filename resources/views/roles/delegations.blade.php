<x-app-layout>
    <div class="mx-auto max-w-5xl space-y-6">
        <x-page-header title="Délégations par agence" eyebrow="Gouvernance des accès" description="Un responsable d’agence ne peut attribuer que les rôles cochés ici et dont les permissions restent sous son propre plafond."><x-slot:actions><a href="{{ route('roles.index') }}" class="rf-button-secondary"><x-icon name="previous" size="xs" />Retour aux rôles</a></x-slot:actions></x-page-header>
        <x-form-errors />
        <div class="space-y-4">
