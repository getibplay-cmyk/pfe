...
<header {{ $attributes->class('space-y-4') }}>
    ...
    <div class="rf-page-heading flex flex-wrap items-center justify-between gap-5">
        <div class="min-w-0 border-s-4 border-belkhir-space-orange ps-4">
            @if ($eyebrow)<p class="mb-2 text-[0.68rem] font-bold uppercase tracking-[0.16em] text-belkhir-space-blue">{{ $eyebrow }}</p>@endif
