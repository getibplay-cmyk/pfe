@props(['title' => __('Aucune donnée'), 'description' => null])
<div {{ $attributes->class('rounded-xl border border-dashed border-belkhir-space-border bg-belkhir-space-canvas px-5 py-9 text-center') }}>
    <span aria-hidden="true" class="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-belkhir-space-orange-soft text-belkhir-space-orange">
