...
<div {{ $attributes->class('rounded-xl border border-dashed border-atlas-border bg-atlas-canvas px-5 py-9 text-center') }}>
    <span aria-hidden="true" class="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-atlas-orange-soft text-atlas-orange">
