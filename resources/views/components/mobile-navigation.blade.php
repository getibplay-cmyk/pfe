@props(['sections', 'user'])
<aside x-ref="mobilePanel" role="dialog" aria-modal="true" aria-label="Menu principal" class="relative flex h-full w-[min(88vw,22rem)] flex-col overflow-y-auto bg-belkhir-space-ink p-5 text-white shadow-2xl" @keydown="trapMenu($event)">
    ...
    <div class="mt-6 border-t border-white/10 pt-4">
        ...
        <a href="{{ route('profile.edit') }}" class="mt-2 inline-flex min-h-10 w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold text-brand-300 hover:bg-white/10 hover:text-white"><x-icon name="users" size="xs" />Mon profil</a>
    </div>
</aside>
