<x-app-layout>
    <div class="mx-auto max-w-6xl space-y-6">
        ...
        @if(auth()->user()->can('update', $customer) && app(App\Support\Tenancy\CustomerPortalContext::class)->canManage(auth()->user()))<a href="{{ route('customers.portal-access.show', $customer) }}" class="rf-button-secondary">Gérer l’accès au portail locataire</a>@endif
        <x-form-errors />
