<x-app-layout>
    <div class="mx-auto max-w-4xl space-y-6">
        <div><a href="{{ route('maintenance.index') }}" class="text-sm text-indigo-700">{{ __('← Maintenance') }}</a><h1 class="mt-2 text-3xl font-bold">{{ __('Planifier une maintenance') }}</h1></div>
