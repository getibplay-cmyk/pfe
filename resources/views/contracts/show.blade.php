    ...
    <div class="rf-page">
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <x-section-card title="Version courante" description="Les empreintes techniques sont contrôlées sans être exposées dans l’interface.">
                ...
                <p class="mt-2 text-xs">{{ $contract->currentVersion?->locked_at ? 'Acceptation enregistrée — version protégée' : 'Non acceptée — toute modification crée une nouvelle version' }}</p>
                @if (! $contractDocument['historical'])
