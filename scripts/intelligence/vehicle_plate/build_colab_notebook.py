#!/usr/bin/env python3
"""Generate the committed Moroccan ANPR v2 Colab notebook."""
...
OUTPUT = ROOT / "notebooks/colab/moroccan_vehicle_plate_anpr_v2.ipynb"
...
def load_cells() -> list[dict[str, Any]]:
    ...
    if not isinstance(items, list) or not items:
        raise ValueError("colab_cells.json doit contenir une liste cells non vide")
