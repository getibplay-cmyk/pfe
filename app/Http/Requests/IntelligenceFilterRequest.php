...
class IntelligenceFilterRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return ($user?->hasPermission('prediction.view') ?? false)
    ...
    {
        $this->merge([
            'date_from' => $this->input('date_from', now()->subDays(30)->toDateString()),
