...
class VehicleDamagePredictionRun extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'max_probability_damage' => 'decimal:10',
            'suggested_damage' => 'boolean',
            'candidate_regions' => 'array',
            'decision_threshold' => 'decimal:10',
    ...
    public function failureLabel(): ?string
    {
        ...
        return match ($this->failure_code) {
            ...
            'MODEL_BACKEND_MISMATCH' => 'Le backend a changé après la mise en queue ; relancez l’analyse avec le modèle actif.',
