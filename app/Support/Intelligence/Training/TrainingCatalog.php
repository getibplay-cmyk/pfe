...
final class TrainingCatalog
{
    public static function all(): array
    {
        return [
            ...
            'damage' => ['label' => 'Détection des dommages', 'baseline' => VehicleDamageContract::MODEL_VERSION, 'recipe' => 'RT-DETRv2, annotations COCO vérifiées', 'metric' => 'F1 des boîtes à IoU 0,50', 'direction' => 'higher'],
